...
// EXTERNAL MODULE: external "/Users/richdubay/Sites/docs/node_modules/react/index.js"
var index_js_ = __webpack_require__(2556);
var index_js_default = /*#__PURE__*/__webpack_require__.n(index_js_);
// EXTERNAL MODULE: ./node_modules/react-helmet/es/Helmet.js
var Helmet = __webpack_require__(4593);
;// CONCATENATED MODULE: ./node_modules/phosphor-react/dist/lib/index.esm.js


var IconContext = /*#__PURE__*/(0,index_js_.createContext)({
  color: "currentColor",
  size: "1em",
  weight: "regular",
  mirrored: false
...
;// CONCATENATED MODULE: ./node_modules/phosphor-react/dist/_virtual/_rollupPluginBabelHelpers.js
...
;// CONCATENATED MODULE: ./node_modules/phosphor-react/dist/lib/IconBase.esm.js




var IconBase = /*#__PURE__*/(0,index_js_.forwardRef)(function (props, ref) {
  ...
  var _useContext = (0,index_js_.useContext)(IconContext),
  ...
  return index_js_default().createElement("svg", Object.assign({
    ref: ref,
  ...
  }, restContext, restProps), children, index_js_default().createElement("rect", {
    width: "256",
    height: "256",
    fill: "none"
...
/* harmony default export */ const IconBase_esm = (IconBase);
//# sourceMappingURL=IconBase.esm.js.map

;// CONCATENATED MODULE: ./node_modules/phosphor-react/dist/icons/GitBranch.esm.js
...
pathsByWeight.set("bold", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
    ...
    strokeWidth: "24"
  }), index_js_default().createElement("line", {
    x1: "68",
    y1: "96",
    x2: "68",
    y2: "160",
...
pathsByWeight.set("duotone", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "188",
    cy: "68",
    r: "28",
    opacity: "0.2"
...
var GitBranch = /*#__PURE__*/(0,index_js_.forwardRef)(function (props, ref) {
  return index_js_default().createElement(IconBase_esm, Object.assign({
    ref: ref
  }, props, {
...
/* harmony default export */ const GitBranch_esm = (GitBranch);
//# sourceMappingURL=GitBranch.esm.js.map

;// CONCATENATED MODULE: ./node_modules/phosphor-react/dist/icons/Code.esm.js




/* GENERATED FILE */
var Code_esm_pathsByWeight = /*#__PURE__*/new Map();
Code_esm_pathsByWeight.set("bold", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polyline", {
    ...
    strokeLinejoin: "round",
    strokeWidth: "24"
  }), index_js_default().createElement("polyline", {
...
Code_esm_pathsByWeight.set("duotone", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polyline", {
    points: "64 88 16 128 64 168",
    fill: "none",
    stroke: color,
...
Code_esm_pathsByWeight.set("fill", function () {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
...
Code_esm_pathsByWeight.set("light", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polyline", {
    points: "64 88 16 128 64 168",
    fill: "none",
    stroke: color,
...
Code_esm_pathsByWeight.set("thin", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polyline", {
    points: "64 88 16 128 64 168",
    fill: "none",
    stroke: color,
...
Code_esm_pathsByWeight.set("regular", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polyline", {
    points: "64 88 16 128 64 168",
    fill: "none",
    stroke: color,
...
var Code_esm_renderPath = function renderPath(weight, color) {
  return renderPathForWeight(weight, color, Code_esm_pathsByWeight);
};

var Code = /*#__PURE__*/(0,index_js_.forwardRef)(function (props, ref) {
  return index_js_default().createElement(IconBase_esm, Object.assign({
    ref: ref
  }, props, {
    renderPath: Code_esm_renderPath
  }));
});
Code.displayName = "Code";

/* harmony default export */ const Code_esm = (Code);
//# sourceMappingURL=Code.esm.js.map

;// CONCATENATED MODULE: ./node_modules/phosphor-react/dist/icons/ChalkboardTeacher.esm.js




/* GENERATED FILE */
var ChalkboardTeacher_esm_pathsByWeight = /*#__PURE__*/new Map();
ChalkboardTeacher_esm_pathsByWeight.set("bold", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "104",
    cy: "148",
    r: "28",
...
ChalkboardTeacher_esm_pathsByWeight.set("duotone", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "104",
    cy: "144",
    r: "32",
...
ChalkboardTeacher_esm_pathsByWeight.set("fill", function () {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
...
ChalkboardTeacher_esm_pathsByWeight.set("light", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "104",
    cy: "144",
    r: "32",
...
ChalkboardTeacher_esm_pathsByWeight.set("thin", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "104",
    cy: "144",
    r: "32",
...
ChalkboardTeacher_esm_pathsByWeight.set("regular", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "104",
    cy: "144",
    r: "32",
...
var ChalkboardTeacher_esm_renderPath = function renderPath(weight, color) {
  return renderPathForWeight(weight, color, ChalkboardTeacher_esm_pathsByWeight);
};

var ChalkboardTeacher = /*#__PURE__*/(0,index_js_.forwardRef)(function (props, ref) {
  return index_js_default().createElement(IconBase_esm, Object.assign({
    ref: ref
  }, props, {
    renderPath: ChalkboardTeacher_esm_renderPath
  }));
});
ChalkboardTeacher.displayName = "ChalkboardTeacher";

/* harmony default export */ const ChalkboardTeacher_esm = (ChalkboardTeacher);
//# sourceMappingURL=ChalkboardTeacher.esm.js.map

;// CONCATENATED MODULE: ./node_modules/phosphor-react/dist/icons/Lightning.esm.js




/* GENERATED FILE */
var Lightning_esm_pathsByWeight = /*#__PURE__*/new Map();
Lightning_esm_pathsByWeight.set("bold", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polygon", {
...
Lightning_esm_pathsByWeight.set("duotone", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polygon", {
    points: "96 240 112 160 48 136 160 16 144 96 208 120 96 240",
    opacity: "0.2"
  }), index_js_default().createElement("polygon", {
    points: "96 240 112 160 48 136 160 16 144 96 208 120 96 240",
    fill: "none",
    stroke: color,
    strokeLinecap: "round",
...
Lightning_esm_pathsByWeight.set("fill", function () {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
...
Lightning_esm_pathsByWeight.set("light", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polygon", {
    points: "96 240 112 160 48 136 160 16 144 96 208 120 96 240",
    fill: "none",
    stroke: color,
...
Lightning_esm_pathsByWeight.set("thin", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polygon", {
    points: "96 240 112 160 48 136 160 16 144 96 208 120 96 240",
    fill: "none",
    stroke: color,
...
Lightning_esm_pathsByWeight.set("regular", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polygon", {
    points: "96 240 112 160 48 136 160 16 144 96 208 120 96 240",
    fill: "none",
    stroke: color,
...
var Lightning_esm_renderPath = function renderPath(weight, color) {
  return renderPathForWeight(weight, color, Lightning_esm_pathsByWeight);
};

var Lightning = /*#__PURE__*/(0,index_js_.forwardRef)(function (props, ref) {
  return index_js_default().createElement(IconBase_esm, Object.assign({
    ref: ref
  }, props, {
    renderPath: Lightning_esm_renderPath
  }));
});
Lightning.displayName = "Lightning";

/* harmony default export */ const Lightning_esm = (Lightning);
//# sourceMappingURL=Lightning.esm.js.map

;// CONCATENATED MODULE: ./node_modules/phosphor-react/dist/icons/Broadcast.esm.js




/* GENERATED FILE */
var Broadcast_esm_pathsByWeight = /*#__PURE__*/new Map();
Broadcast_esm_pathsByWeight.set("bold", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "128",
    cy: "128",
    r: "32",
...
Broadcast_esm_pathsByWeight.set("duotone", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "128",
    cy: "128",
    r: "32",
...
Broadcast_esm_pathsByWeight.set("fill", function () {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "128",
    cy: "128",
    r: "40"
...
Broadcast_esm_pathsByWeight.set("light", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "128",
    cy: "128",
    r: "32",
...
Broadcast_esm_pathsByWeight.set("thin", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "128",
    cy: "128",
    r: "32",
...
Broadcast_esm_pathsByWeight.set("regular", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "128",
    cy: "128",
    r: "32",
...
var Broadcast_esm_renderPath = function renderPath(weight, color) {
  return renderPathForWeight(weight, color, Broadcast_esm_pathsByWeight);
};

var Broadcast = /*#__PURE__*/(0,index_js_.forwardRef)(function (props, ref) {
  return index_js_default().createElement(IconBase_esm, Object.assign({
    ref: ref
  }, props, {
    renderPath: Broadcast_esm_renderPath
  }));
});
Broadcast.displayName = "Broadcast";

/* harmony default export */ const Broadcast_esm = (Broadcast);
//# sourceMappingURL=Broadcast.esm.js.map

;// CONCATENATED MODULE: ./node_modules/phosphor-react/dist/icons/GlobeHemisphereWest.esm.js




/* GENERATED FILE */
var GlobeHemisphereWest_esm_pathsByWeight = /*#__PURE__*/new Map();
GlobeHemisphereWest_esm_pathsByWeight.set("bold", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "128",
    cy: "128",
    r: "96",
...
GlobeHemisphereWest_esm_pathsByWeight.set("duotone", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
...
GlobeHemisphereWest_esm_pathsByWeight.set("fill", function () {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
...
GlobeHemisphereWest_esm_pathsByWeight.set("light", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "128",
    cy: "128",
    r: "96",
...
GlobeHemisphereWest_esm_pathsByWeight.set("thin", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "128",
    cy: "128",
    r: "96",
...
GlobeHemisphereWest_esm_pathsByWeight.set("regular", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "128",
    cy: "128",
    r: "96",
...
var GlobeHemisphereWest_esm_renderPath = function renderPath(weight, color) {
  return renderPathForWeight(weight, color, GlobeHemisphereWest_esm_pathsByWeight);
};

var GlobeHemisphereWest = /*#__PURE__*/(0,index_js_.forwardRef)(function (props, ref) {
  return index_js_default().createElement(IconBase_esm, Object.assign({
    ref: ref
  }, props, {
    renderPath: GlobeHemisphereWest_esm_renderPath
  }));
});
GlobeHemisphereWest.displayName = "GlobeHemisphereWest";

/* harmony default export */ const GlobeHemisphereWest_esm = (GlobeHemisphereWest);
//# sourceMappingURL=GlobeHemisphereWest.esm.js.map

;// CONCATENATED MODULE: ./node_modules/phosphor-react/dist/icons/Users.esm.js




/* GENERATED FILE */
var Users_esm_pathsByWeight = /*#__PURE__*/new Map();
Users_esm_pathsByWeight.set("bold", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "88",
    cy: "108",
    r: "52",
...
Users_esm_pathsByWeight.set("duotone", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "88",
    cy: "108",
    r: "52",
...
Users_esm_pathsByWeight.set("fill", function () {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
...
Users_esm_pathsByWeight.set("light", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "88",
    cy: "108",
    r: "52",
...
Users_esm_pathsByWeight.set("thin", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "88",
    cy: "108",
    r: "52",
...
Users_esm_pathsByWeight.set("regular", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "88",
    cy: "108",
    r: "52",
...
var Users_esm_renderPath = function renderPath(weight, color) {
  return renderPathForWeight(weight, color, Users_esm_pathsByWeight);
};

var Users = /*#__PURE__*/(0,index_js_.forwardRef)(function (props, ref) {
  return index_js_default().createElement(IconBase_esm, Object.assign({
    ref: ref
  }, props, {
    renderPath: Users_esm_renderPath
  }));
});
Users.displayName = "Users";

/* harmony default export */ const Users_esm = (Users);
//# sourceMappingURL=Users.esm.js.map

;// CONCATENATED MODULE: ./node_modules/phosphor-react/dist/icons/Heart.esm.js




/* GENERATED FILE */
var Heart_esm_pathsByWeight = /*#__PURE__*/new Map();
Heart_esm_pathsByWeight.set("bold", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
...
Heart_esm_pathsByWeight.set("duotone", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
    d: "M128,216S28,160,28,92A52,52,0,0,1,128,72h0A52,52,0,0,1,228,92C228,160,128,216,128,216Z",
    opacity: "0.2"
  }), index_js_default().createElement("path", {
...
Heart_esm_pathsByWeight.set("fill", function () {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
...
Heart_esm_pathsByWeight.set("light", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
    d: "M128,216S28,160,28,92A52,52,0,0,1,128,72h0A52,52,0,0,1,228,92C228,160,128,216,128,216Z",
    fill: "none",
    stroke: color,
...
Heart_esm_pathsByWeight.set("thin", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
    d: "M128,216S28,160,28,92A52,52,0,0,1,128,72h0A52,52,0,0,1,228,92C228,160,128,216,128,216Z",
    fill: "none",
    stroke: color,
...
Heart_esm_pathsByWeight.set("regular", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
    d: "M128,216S28,160,28,92A52,52,0,0,1,128,72h0A52,52,0,0,1,228,92C228,160,128,216,128,216Z",
    fill: "none",
    stroke: color,
...
var Heart_esm_renderPath = function renderPath(weight, color) {
  return renderPathForWeight(weight, color, Heart_esm_pathsByWeight);
};

var Heart = /*#__PURE__*/(0,index_js_.forwardRef)(function (props, ref) {
  return index_js_default().createElement(IconBase_esm, Object.assign({
    ref: ref
  }, props, {
    renderPath: Heart_esm_renderPath
  }));
});
Heart.displayName = "Heart";

/* harmony default export */ const Heart_esm = (Heart);
//# sourceMappingURL=Heart.esm.js.map

;// CONCATENATED MODULE: ./node_modules/phosphor-react/dist/icons/UserSquare.esm.js




/* GENERATED FILE */
var UserSquare_esm_pathsByWeight = /*#__PURE__*/new Map();
UserSquare_esm_pathsByWeight.set("bold", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "128",
    cy: "120",
    r: "40",
...
UserSquare_esm_pathsByWeight.set("duotone", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
...
UserSquare_esm_pathsByWeight.set("fill", function () {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "128",
    cy: "120",
    r: "44"
...
UserSquare_esm_pathsByWeight.set("light", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "128",
    cy: "120",
    r: "40",
...
UserSquare_esm_pathsByWeight.set("thin", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "128",
    cy: "120",
    r: "40",
...
UserSquare_esm_pathsByWeight.set("regular", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("circle", {
    cx: "128",
    cy: "120",
    r: "40",
...
var UserSquare_esm_renderPath = function renderPath(weight, color) {
  return renderPathForWeight(weight, color, UserSquare_esm_pathsByWeight);
};

var UserSquare = /*#__PURE__*/(0,index_js_.forwardRef)(function (props, ref) {
  return index_js_default().createElement(IconBase_esm, Object.assign({
    ref: ref
  }, props, {
    renderPath: UserSquare_esm_renderPath
  }));
});
UserSquare.displayName = "UserSquare";

/* harmony default export */ const UserSquare_esm = (UserSquare);
//# sourceMappingURL=UserSquare.esm.js.map

;// CONCATENATED MODULE: ./node_modules/phosphor-react/dist/icons/TrendUp.esm.js




/* GENERATED FILE */
var TrendUp_esm_pathsByWeight = /*#__PURE__*/new Map();
TrendUp_esm_pathsByWeight.set("bold", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polyline", {
...
TrendUp_esm_pathsByWeight.set("duotone", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polyline", {
    points: "232 56 136 152 96 112 24 184",
    fill: "none",
    stroke: color,
...
TrendUp_esm_pathsByWeight.set("fill", function () {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
...
TrendUp_esm_pathsByWeight.set("light", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polyline", {
    points: "232 56 136 152 96 112 24 184",
    fill: "none",
    stroke: color,
...
TrendUp_esm_pathsByWeight.set("thin", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polyline", {
    points: "232 56 136 152 96 112 24 184",
    fill: "none",
    stroke: color,
...
TrendUp_esm_pathsByWeight.set("regular", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polyline", {
    points: "232 56 136 152 96 112 24 184",
    fill: "none",
    stroke: color,
...
var TrendUp_esm_renderPath = function renderPath(weight, color) {
  return renderPathForWeight(weight, color, TrendUp_esm_pathsByWeight);
};

var TrendUp = /*#__PURE__*/(0,index_js_.forwardRef)(function (props, ref) {
  return index_js_default().createElement(IconBase_esm, Object.assign({
    ref: ref
  }, props, {
    renderPath: TrendUp_esm_renderPath
  }));
});
TrendUp.displayName = "TrendUp";

/* harmony default export */ const TrendUp_esm = (TrendUp);
//# sourceMappingURL=TrendUp.esm.js.map

;// CONCATENATED MODULE: ./node_modules/phosphor-react/dist/icons/YoutubeLogo.esm.js




/* GENERATED FILE */
var YoutubeLogo_esm_pathsByWeight = /*#__PURE__*/new Map();
YoutubeLogo_esm_pathsByWeight.set("bold", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polygon", {
...
YoutubeLogo_esm_pathsByWeight.set("duotone", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
...
YoutubeLogo_esm_pathsByWeight.set("thin", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polygon", {
    points: "160 128 112 96 112 160 160 128",
    fill: "none",
    stroke: color,
...
YoutubeLogo_esm_pathsByWeight.set("regular", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("polygon", {
    points: "160 128 112 96 112 160 160 128",
    fill: "none",
    stroke: color,
...
var YoutubeLogo_esm_renderPath = function renderPath(weight, color) {
  return renderPathForWeight(weight, color, YoutubeLogo_esm_pathsByWeight);
};

var YoutubeLogo = /*#__PURE__*/(0,index_js_.forwardRef)(function (props, ref) {
  return index_js_default().createElement(IconBase_esm, Object.assign({
    ref: ref
  }, props, {
    renderPath: YoutubeLogo_esm_renderPath
  }));
});
YoutubeLogo.displayName = "YoutubeLogo";

/* harmony default export */ const YoutubeLogo_esm = (YoutubeLogo);
//# sourceMappingURL=YoutubeLogo.esm.js.map

;// CONCATENATED MODULE: ./node_modules/phosphor-react/dist/icons/RocketLaunch.esm.js




/* GENERATED FILE */
var RocketLaunch_esm_pathsByWeight = /*#__PURE__*/new Map();
RocketLaunch_esm_pathsByWeight.set("bold", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
...
RocketLaunch_esm_pathsByWeight.set("duotone", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
...
RocketLaunch_esm_pathsByWeight.set("fill", function () {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
...
RocketLaunch_esm_pathsByWeight.set("light", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
    d: "M94.1,184.6c-11.4,33.9-56.6,33.9-56.6,33.9s0-45.2,33.9-56.6",
    fill: "none",
    stroke: color,
...
RocketLaunch_esm_pathsByWeight.set("thin", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
    d: "M94.1,184.6c-11.4,33.9-56.6,33.9-56.6,33.9s0-45.2,33.9-56.6",
    fill: "none",
    stroke: color,
...
RocketLaunch_esm_pathsByWeight.set("regular", function (color) {
  return index_js_default().createElement((index_js_default()).Fragment, null, index_js_default().createElement("path", {
    d: "M94.1,184.6c-11.4,33.9-56.6,33.9-56.6,33.9s0-45.2,33.9-56.6",
    fill: "none",
    stroke: color,
...
var RocketLaunch_esm_renderPath = function renderPath(weight, color) {
  return renderPathForWeight(weight, color, RocketLaunch_esm_pathsByWeight);
};

var RocketLaunch = /*#__PURE__*/(0,index_js_.forwardRef)(function (props, ref) {
  return index_js_default().createElement(IconBase_esm, Object.assign({
    ref: ref
  }, props, {
    renderPath: RocketLaunch_esm_renderPath
  }));
});
RocketLaunch.displayName = "RocketLaunch";

/* harmony default export */ const RocketLaunch_esm = (RocketLaunch);
...
const Divider=()=>{return/*#__PURE__*/index_js_.createElement("div",{className:"relative"},/*#__PURE__*/index_js_.createElement("div",{className:"absolute inset-0 flex items-center","aria-hidden":"true"},/*#__PURE__*/index_js_.createElement("div",{className:"w-full border-t border-gray-300"})),/*#__PURE__*/index_js_.createElement("div",{className:"relative flex justify-center"},/*#__PURE__*/index_js_.createElement("span",{className:"bg-[#f8f8fb] px-2 text-gray-500"},/*#__PURE__*/index_js_.createElement("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg"},/*#__PURE__*/index_js_.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M0 24L9.39372 0H14.6063L24 24H0ZM11.8571 5.8363L6.92808 19.4399H17.0847L12.1556 5.8363H11.8571Z",fill:"#00676D"})))));};/* harmony default export */ const components_Divider = (Divider);
// EXTERNAL MODULE: ./src/images/svgs/logo.svg
var logo = __webpack_require__(7613);
var logo_default = /*#__PURE__*/__webpack_require__.n(logo);
// EXTERNAL MODULE: ./src/images/svgs/apollos.svg
var apollos = __webpack_require__(9650);
var apollos_default = /*#__PURE__*/__webpack_require__.n(apollos);
;// CONCATENATED MODULE: ./src/pages/index.js
const IndexPage=()=>{const features=[{name:'Open source & open license',description:'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.',icon:GitBranch_esm},{name:'Developer-supported community',description:'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.',icon:Code_esm},{name:'Lead with collaboration and strategy',description:'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.',icon:ChalkboardTeacher_esm}];return/*#__PURE__*/index_js_.createElement(index_js_.Fragment,null,/*#__PURE__*/index_js_.createElement(Helmet.Helmet,null,/*#__PURE__*/index_js_.createElement("link",{rel:"stylesheet",href:"https://rsms.me/inter/inter.css"})),/*#__PURE__*/index_js_.createElement("div",null,/*#__PURE__*/index_js_.createElement("div",{className:"page-background"},/*#__PURE__*/index_js_.createElement("div",{className:"pt-6 pb-80 px-6 lg:px-16 green-background text-white"},/*#__PURE__*/index_js_.createElement("div",{className:"flex flex-row justify-between items-center"},/*#__PURE__*/index_js_.createElement((apollos_default()),null),/*#__PURE__*/index_js_.createElement("a",{href:"#",className:"hidden md:flex w-full sm:w-auto px-6 py-3 text-base font-medium text-white get-started-button shadow-lg rounded-md inline-flex items-center justify-center gap-2 hover:bg-white hover:text-base-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-base-secondary hover:bg-base-secondary hover:text-white"},"Get Started")),/*#__PURE__*/index_js_.createElement("div",{className:"max-w-xl mx-auto my-12 lg:my-16"},/*#__PURE__*/index_js_.createElement("div",{className:"text-center flex flex-col items-center"},/*#__PURE__*/index_js_.createElement((logo_default()),null),/*#__PURE__*/index_js_.createElement("div",{className:"pb-14 pt-8"},/*#__PURE__*/index_js_.createElement("p",{className:"text-white font-semibold uppercase text-sm"},"We\u2019ll help your community"),/*#__PURE__*/index_js_.createElement("p",{className:"pb-8 pt-4 font-extrabold text-6xl"},"Be the Church,",' ',/*#__PURE__*/index_js_.createElement("span",{className:"text-base-tertiary"},"everyday"),"."),/*#__PURE__*/index_js_.createElement("p",{className:"max-w-sm mx-auto text-xl text-dark-secondary"},/*#__PURE__*/index_js_.createElement("span",{className:"opacity-60"},"With ",/*#__PURE__*/index_js_.createElement("span",{className:"italic"},"daily")),' ',"Personalized Discipleship",/*#__PURE__*/index_js_.createElement("span",{className:"opacity-60"}," and")," Spiritual Fitness,",' ',/*#__PURE__*/index_js_.createElement("span",{className:"opacity-60"},"the Apollos Platform helps your church thrive."))),/*#__PURE__*/index_js_.createElement("p",{className:"text-white font-semibold uppercase text-sm pb-2"},"Used By")),/*#__PURE__*/index_js_.createElement("div",{className:"flex gap-x-8 gap-y-4 flex-wrap justify-center"},/*#__PURE__*/index_js_.createElement("div",null,/*#__PURE__*/index_js_.createElement("img",{className:"h-8",src:"https://tailwindui.com/img/logos/laravel-logo-gray-400.svg",alt:"Laravel"})),/*#__PURE__*/index_js_.createElement("div",null,/*#__PURE__*/index_js_.createElement("img",{className:"h-8",src:"https://tailwindui.com/img/logos/mirage-logo-gray-400.svg",alt:"Mirage"})),/*#__PURE__*/index_js_.createElement("div",null,/*#__PURE__*/index_js_.createElement("img",{className:"h-8",src:"https://tailwindui.com/img/logos/transistor-logo-gray-400.svg",alt:"Transistor"})),/*#__PURE__*/index_js_.createElement("div",null,/*#__PURE__*/index_js_.createElement("img",{className:"h-8",src:"https://tailwindui.com/img/logos/tuple-logo-gray-400.svg",alt:"Tuple"})),/*#__PURE__*/index_js_.createElement("div",null,/*#__PURE__*/index_js_.createElement("img",{className:"h-8",src:"https://tailwindui.com/img/logos/workcation-logo-gray-400.svg",alt:"Workcation"})),/*#__PURE__*/index_js_.createElement("div",null,/*#__PURE__*/index_js_.createElement("img",{className:"h-8",src:"https://tailwindui.com/img/logos/statickit-logo-gray-400.svg",alt:"StaticKit"}))))),/*#__PURE__*/index_js_.createElement("div",{className:"max-w-6xl mx-auto"},/*#__PURE__*/index_js_.createElement(J,{className:"h-full w-full lg:h-3/4 lg:w-3/4 transform translate-y-1/4 lg:translate-y-1/4 lg:translate-x-1/3",src:"../images/phone.png",alt:"phone",__imageData:__webpack_require__(6524)})),/*#__PURE__*/index_js_.createElement("div",{className:"max-w-6xl mx-auto px-9 py-16 hand-background-mobile lg:hand-background relative"},/*#__PURE__*/index_js_.createElement("p",{className:"text-sm text-base-secondary font-semibold uppercase"},"Digital Growth Platform"),/*#__PURE__*/index_js_.createElement("h1",{className:"max-w-xl pt-4 text-4xl md:text-5xl font-extrabold md:leading-[3.75rem] tracking-tight text-primary"},"Shepherd your community",' ',/*#__PURE__*/index_js_.createElement("span",{className:"italic"},"all week long"),"."),/*#__PURE__*/index_js_.createElement("div",{className:"lg:grid lg:grid-cols-2 lg:gap-8"},/*#__PURE__*/index_js_.createElement("p",{className:"mt-4 text-lg text-gray-700/60 lg:mx-auto leading-6"},/*#__PURE__*/index_js_.createElement("span",{className:"font-medium text-gray-700"},"Disciple making is tough when"),' ',"people are isolated and not genuinely connecting. Online communities are disconnected, your followers lack clear steps, and you don\u2019t have the data to make confident strategic decisions."),/*#__PURE__*/index_js_.createElement("p",{className:"mt-4 text-lg text-gray-700/60 lg:mx-auto leading-6"},/*#__PURE__*/index_js_.createElement("span",{className:"font-medium text-gray-700"},"But when you partner with Apollos,"),' ',"everyone in your following will have clear next steps, they\u2019ll experience easy ways to connect with others, and they\u2019ll finally make it a habit to engage in scripture and prayer daily.")),/*#__PURE__*/index_js_.createElement("div",{className:"mt-8 flex justify-center"},/*#__PURE__*/index_js_.createElement("a",{href:"#",className:"w-full sm:w-auto px-6 py-3 text-base font-medium text-white green-button shadow-lg rounded-md inline-flex items-center justify-center gap-2 hover:bg-white hover:text-base-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-base-secondary hover:bg-base-secondary hover:text-white"},/*#__PURE__*/index_js_.createElement(Lightning_esm,{"aria-hidden":"true",className:"h-5 w-5"}),"Book a Demo"))),/*#__PURE__*/index_js_.createElement("div",{className:"max-w-6xl mx-auto px-4 sm:px-6 lg:px-8"},/*#__PURE__*/index_js_.createElement("div",{className:"columns-2 lg:columns-3 gap-2 md:gap-8"},/*#__PURE__*/index_js_.createElement(J,{className:"w-full h-full object-cover md:m-4 mb-2 shadow-lg md:shadow-xl",src:"../images/kaleb2.png",alt:"Kaleb",__imageData:__webpack_require__(8820)}),/*#__PURE__*/index_js_.createElement(J,{className:"w-full h-full object-cover md:m-4 mb-2 shadow-lg md:shadow-xl",src:"../images/jeff2.png",alt:"Jeff",__imageData:__webpack_require__(6239)}),/*#__PURE__*/index_js_.createElement(J,{className:"w-full h-full object-cover md:m-4 mb-2 shadow-lg md:shadow-xl",src:"../images/brad2.png",alt:"Brad",__imageData:__webpack_require__(5549)}),/*#__PURE__*/index_js_.createElement(J,{className:"w-full h-full object-cover md:m-4 mb-2 shadow-lg md:shadow-xl",src:"../images/lisa2.png",alt:"Lisa",__imageData:__webpack_require__(8806)}),/*#__PURE__*/index_js_.createElement(J,{className:"w-full h-full object-cover md:m-4 mb-2 shadow-lg md:shadow-xl",src:"../images/monsters2.png",alt:"Monsters",__imageData:__webpack_require__(4575)}),/*#__PURE__*/index_js_.createElement(J,{className:"w-full h-full object-cover md:m-4 mb-2 shadow-lg md:shadow-xl",src:"../images/paul2.png",alt:"Paul",__imageData:__webpack_require__(4688)}))),/*#__PURE__*/index_js_.createElement("section",{className:"pb-24 pt-16"},/*#__PURE__*/index_js_.createElement("div",{className:"relative max-w-7xl mx-auto px-12"},/*#__PURE__*/index_js_.createElement("svg",{className:"absolute top-full right-full transform translate-x-1/2 -translate-y-1/4 lg:translate-x-1/2 xl:-translate-y-1/4",width:404,height:404,fill:"none",viewBox:"0 0 404 404",role:"img","aria-labelledby":"svg-workcation"},/*#__PURE__*/index_js_.createElement("title",{id:"svg-workcation"},"Workcation"),/*#__PURE__*/index_js_.createElement("defs",null,/*#__PURE__*/index_js_.createElement("pattern",{id:"ad119f34-7694-4c31-947f-5c9d249b21f3",x:0,y:0,width:20,height:20,patternUnits:"userSpaceOnUse"},/*#__PURE__*/index_js_.createElement("rect",{x:0,y:0,width:4,height:4,className:"text-gray-200",fill:"currentColor"}))),/*#__PURE__*/index_js_.createElement("rect",{width:404,height:404,fill:"url(#ad119f34-7694-4c31-947f-5c9d249b21f3)"})),/*#__PURE__*/index_js_.createElement("div",{className:"relative"},/*#__PURE__*/index_js_.createElement("img",{className:"mx-auto h-8 text-base-primary",fill:"currentColor",src:"https://tailwindui.com/img/logos/workcation-logo-indigo-600-mark-gray-800-and-indigo-600-text.svg",alt:"Workcation"}),/*#__PURE__*/index_js_.createElement("blockquote",{className:"mt-10"},/*#__PURE__*/index_js_.createElement("div",{className:"max-w-3xl mx-auto text-center text-lg lg:text-2xl lg:leading-9 font-medium text-gray-900"},/*#__PURE__*/index_js_.createElement("p",null,"\u201CLorem ipsum dolor sit amet consectetur adipisicing elit. Nemo expedita voluptas culpa sapiente alias molestiae. Numquam corrupti in laborum sed rerum et corporis.\u201D")),/*#__PURE__*/index_js_.createElement("footer",{className:"mt-8"},/*#__PURE__*/index_js_.createElement("div",{className:"md:flex md:items-center md:justify-center"},/*#__PURE__*/index_js_.createElement("div",{className:"md:flex-shrink-0"},/*#__PURE__*/index_js_.createElement("img",{className:"mx-auto h-10 w-10 rounded-full",src:"https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",alt:""})),/*#__PURE__*/index_js_.createElement("div",{className:"mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center"},/*#__PURE__*/index_js_.createElement("div",{className:"text-base font-medium text-gray-900"},"Judith Black"),/*#__PURE__*/index_js_.createElement("svg",{className:"hidden md:block mx-1 h-5 w-5 text-base-primary",fill:"currentColor",viewBox:"0 0 20 20"},/*#__PURE__*/index_js_.createElement("path",{d:"M11 0h3L9 20H6l5-20z"})),/*#__PURE__*/index_js_.createElement("div",{className:"text-base font-medium text-gray-500"},"CEO, Workcation")))))))),/*#__PURE__*/index_js_.createElement("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"},/*#__PURE__*/index_js_.createElement("div",{className:"relative engagement rounded-lg overflow-hidden space-4 shadow-xl"},/*#__PURE__*/index_js_.createElement("div",{className:"px-4 py-12 sm:px-6 lg:px-16 lg:py-16"},/*#__PURE__*/index_js_.createElement("div",{className:"md:mr-auto md:w-1/2 md:pr-10"},/*#__PURE__*/index_js_.createElement("p",{className:"text-sm text-base-secondary font-semibold uppercase"},"Experience"),/*#__PURE__*/index_js_.createElement("h1",{className:"pt-4 text-5xl font-extrabold leading-12 tracking-tight text-white line-through"},"Engagement"),/*#__PURE__*/index_js_.createElement("h1",{className:"text-5xl font-extrabold leading-12 tracking-tight text-white italic"},"Growth."),/*#__PURE__*/index_js_.createElement("p",{className:"mt-4 max-w-4xl text-lg text-dark-secondary/60 lg:mx-auto"},"When your goal is engagement it can be hard to measure how people are actually changing. We focus on building technologies that make",' ',/*#__PURE__*/index_js_.createElement("span",{className:"text-white"},"growing")," with your faith, family and friends",' ',/*#__PURE__*/index_js_.createElement("span",{className:"text-white"},"a daily habit"),"."),/*#__PURE__*/index_js_.createElement("div",{className:"mt-8"},/*#__PURE__*/index_js_.createElement("div",{className:"rounded-md shadow"},/*#__PURE__*/index_js_.createElement("a",{href:"#",className:"w-full sm:w-auto px-6 py-3 text-base font-medium text-base-secondary bg-white shadow-sm rounded-md inline-flex items-center justify-center gap-3 hover:bg-base-secondary hover:text-white"},/*#__PURE__*/index_js_.createElement(Broadcast_esm,{"aria-hidden":"true",className:"h-5 w-5"}),"See Apollos in Action"))))),/*#__PURE__*/index_js_.createElement("div",{className:"bg-indigo-600 md:absolute md:right-0 md:top-0 md:h-full md:w-1/2"},/*#__PURE__*/index_js_.createElement(J,{className:"w-full h-full object-cover",src:"../images/engagement.png",alt:"Person on phone using the Apollos app",__imageData:__webpack_require__(2973)})))),/*#__PURE__*/index_js_.createElement("div",{className:"pb-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center"},/*#__PURE__*/index_js_.createElement("div",{className:"text-center py-16 lg:py-24 flex flex-col items-center"},/*#__PURE__*/index_js_.createElement("p",{className:"text-base text-base-secondary font-semibold uppercase"},"Growth Plan"),/*#__PURE__*/index_js_.createElement("p",{className:"mt-2 max-w-3xl text-3xl sm:text-5xl leading-8 font-extrabold tracking-tight text-gray-900"},"Everything you need to grow your digital ministry"),/*#__PURE__*/index_js_.createElement("p",{className:"mt-4 max-w-4xl text-xl text-gray-500 lg:mx-auto"},"Phasellus lorem quam molestie id quisque diam aenean nulla in. Accumsan in quis quis nunc, ullamcorper malesuada. Eleifend condimentum id viverra nulla.")),/*#__PURE__*/index_js_.createElement("div",{className:"lg:columns-2 lg:gap-8"},/*#__PURE__*/index_js_.createElement("div",{className:"py-4 max-w-lg"},/*#__PURE__*/index_js_.createElement("div",{className:'bg-light-secondary rounded-2xl'},/*#__PURE__*/index_js_.createElement("div",{className:'pt-6 px-6 lg:pt-8 lg:px-8'},/*#__PURE__*/index_js_.createElement("div",{className:'flex items-center justify-center h-12 w-12 rounded-full bg-icon-bluegreen text-base-secondary mb-5'},/*#__PURE__*/index_js_.createElement(GlobeHemisphereWest_esm,{className:"h-6 w-6","aria-hidden":"true"})),/*#__PURE__*/index_js_.createElement("p",{className:`text-base text-base-secondary font-semibold uppercase`},"Mobile, TV & Web"),/*#__PURE__*/index_js_.createElement("h1",{className:"text-3xl lg:text-4xl font-extrabold pb-5 pt-2"},"Connect on every device"),/*#__PURE__*/index_js_.createElement("div",{className:"text-gray-500 text-xl"},"Phasellus lorem quam molestie id quisque diam aenean nulla in. Accumsan in quis quis nunc, ullamcorper malesuada. Eleifend condimentum id viverra nulla.")),/*#__PURE__*/index_js_.createElement("div",{className:"flex pt-4 justify-center"},/*#__PURE__*/index_js_.createElement(J,{className:"w-full h-full object-cover",src:"../images/image-1.png",alt:"Pipeline Screenshot",__imageData:__webpack_require__(8188)})))),/*#__PURE__*/index_js_.createElement("div",{className:"py-4 max-w-lg"},/*#__PURE__*/index_js_.createElement("div",{className:'bg-light-lavender rounded-2xl'},/*#__PURE__*/index_js_.createElement("div",{className:'pt-6 px-6 lg:pt-8 lg:px-8'},/*#__PURE__*/index_js_.createElement("div",{className:'flex items-center justify-center h-12 w-12 rounded-full bg-icon-lavender text-base-lavender mb-5'},/*#__PURE__*/index_js_.createElement(Users_esm,{className:"h-6 w-6","aria-hidden":"true"})),/*#__PURE__*/index_js_.createElement("p",{className:`text-base text-base-lavender font-semibold uppercase`},"Sub-head"),/*#__PURE__*/index_js_.createElement("h1",{className:"text-3xl lg:text-4xl font-extrabold pb-5 pt-2"},"Host healthy groups"),/*#__PURE__*/index_js_.createElement("div",{className:"text-gray-500 text-xl"},"Phasellus lorem quam molestie id quisque diam aenean nulla in. Accumsan in quis quis nunc, ullamcorper malesuada. Eleifend condimentum id viverra nulla.")),/*#__PURE__*/index_js_.createElement("div",{className:"flex pt-4 justify-center"},/*#__PURE__*/index_js_.createElement(J,{className:"object-cover",src:"../images/image-2.png",alt:"Pipeline Screenshot",__imageData:__webpack_require__(9921)})))),/*#__PURE__*/index_js_.createElement("div",{className:"py-4 max-w-lg lg:break-after-column"},/*#__PURE__*/index_js_.createElement("div",{className:'bg-light-mint rounded-2xl'},/*#__PURE__*/index_js_.createElement("div",{className:'pt-6 px-6 lg:pt-8 lg:px-8'},/*#__PURE__*/index_js_.createElement("div",{className:'flex items-center justify-center h-12 w-12 rounded-full bg-icon-mint text-base-mint mb-5'},/*#__PURE__*/index_js_.createElement(Heart_esm,{className:"h-6 w-6","aria-hidden":"true"})),/*#__PURE__*/index_js_.createElement("p",{className:`text-base text-base-mint font-semibold uppercase`},"Sub-head"),/*#__PURE__*/index_js_.createElement("h1",{className:"text-3xl lg:text-4xl font-extrabold pb-5 pt-2"},"Increase generosity"),/*#__PURE__*/index_js_.createElement("div",{className:"text-gray-500 text-xl"},"Phasellus lorem quam molestie id quisque diam aenean nulla in. Accumsan in quis quis nunc, ullamcorper malesuada. Eleifend condimentum id viverra nulla.")),/*#__PURE__*/index_js_.createElement("div",{className:"flex pt-4 justify-center"},/*#__PURE__*/index_js_.createElement(J,{className:"object-cover",src:"../images/image-3.png",alt:"Pipeline Screenshot",__imageData:__webpack_require__(2773)})))),/*#__PURE__*/index_js_.createElement("div",{className:"py-4 max-w-lg"},/*#__PURE__*/index_js_.createElement("div",{className:'bg-light-tan rounded-2xl'},/*#__PURE__*/index_js_.createElement("div",{className:"flex pt-4 justify-center"},/*#__PURE__*/index_js_.createElement(J,{className:"object-cover",src:"../images/image-4.png",alt:"Pipeline Screenshot",__imageData:__webpack_require__(4844)})),/*#__PURE__*/index_js_.createElement("div",{className:'pb-6 px-6 lg:pb-8 lg:px-8'},/*#__PURE__*/index_js_.createElement("div",{className:'flex items-center justify-center h-12 w-12 rounded-full bg-icon-tan text-base-tan mb-5'},/*#__PURE__*/index_js_.createElement(UserSquare_esm,{className:"h-6 w-6","aria-hidden":"true"})),/*#__PURE__*/index_js_.createElement("p",{className:`text-base text-base-tan font-semibold uppercase`},"Sub-head"),/*#__PURE__*/index_js_.createElement("h1",{className:"text-3xl lg:text-4xl font-extrabold pb-5 pt-2"},"Disciple personally"),/*#__PURE__*/index_js_.createElement("div",{className:"text-gray-500 text-xl"},"Phasellus lorem quam molestie id quisque diam aenean nulla in. Accumsan in quis quis nunc, ullamcorper malesuada. Eleifend condimentum id viverra nulla.")))),/*#__PURE__*/index_js_.createElement("div",{className:"py-4 max-w-lg"},/*#__PURE__*/index_js_.createElement("div",{className:'bg-light-blue rounded-2xl'},/*#__PURE__*/index_js_.createElement("div",{className:"flex pt-4 justify-center"},/*#__PURE__*/index_js_.createElement(J,{className:"object-cover",src:"../images/image-5.png",alt:"Pipeline Screenshot",__imageData:__webpack_require__(9828)})),/*#__PURE__*/index_js_.createElement("div",{className:'pb-6 px-6 lg:pb-8 lg:px-8'},/*#__PURE__*/index_js_.createElement("div",{className:'flex items-center justify-center h-12 w-12 rounded-full bg-icon-blue text-base-blue mb-5'},/*#__PURE__*/index_js_.createElement(TrendUp_esm,{className:"h-6 w-6","aria-hidden":"true"})),/*#__PURE__*/index_js_.createElement("p",{className:`text-base text-base-blue font-semibold uppercase`},"Sub-head"),/*#__PURE__*/index_js_.createElement("h1",{className:"text-3xl lg:text-4xl font-extrabold pb-5 pt-2"},"Build daily habits"),/*#__PURE__*/index_js_.createElement("div",{className:"text-gray-500 text-xl"},"Phasellus lorem quam molestie id quisque diam aenean nulla in. Accumsan in quis quis nunc, ullamcorper malesuada. Eleifend condimentum id viverra nulla.")))),/*#__PURE__*/index_js_.createElement("div",{className:"py-4 max-w-lg"},/*#__PURE__*/index_js_.createElement("div",{className:'bg-light-red rounded-2xl'},/*#__PURE__*/index_js_.createElement("div",{className:"flex pt-8 justify-center"},/*#__PURE__*/index_js_.createElement(J,{className:"object-cover",src:"../images/image-6.png",alt:"Pipeline Screenshot",__imageData:__webpack_require__(871)})),/*#__PURE__*/index_js_.createElement("div",{className:'pb-6 px-6 lg:pb-8 lg:px-8'},/*#__PURE__*/index_js_.createElement("div",{className:'flex items-center justify-center h-12 w-12 rounded-full bg-icon-red text-base-red mb-5'},/*#__PURE__*/index_js_.createElement(YoutubeLogo_esm,{className:"h-6 w-6","aria-hidden":"true"})),/*#__PURE__*/index_js_.createElement("p",{className:`text-base text-base-red font-semibold uppercase`},"Sub-head"),/*#__PURE__*/index_js_.createElement("h1",{className:"text-3xl lg:text-4xl font-extrabold pb-5 pt-2"},"Watch & grow"),/*#__PURE__*/index_js_.createElement("div",{className:"text-gray-500 text-xl"},"Phasellus lorem quam molestie id quisque diam aenean nulla in. Accumsan in quis quis nunc, ullamcorper malesuada. Eleifend condimentum id viverra nulla.")))))),/*#__PURE__*/index_js_.createElement("div",{className:"max-w-2xl mx-auto px-4"},/*#__PURE__*/index_js_.createElement(components_Divider,null)),/*#__PURE__*/index_js_.createElement("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-24 space-y-8 lg:space-y-24"},/*#__PURE__*/index_js_.createElement("div",{className:"pipeline-green-background rounded-lg shadow-xl overflow-hidden"},/*#__PURE__*/index_js_.createElement("div",{className:"px-6 py-10 sm:px-16 sm:py-16 xl:px-20 xl:py-20"},/*#__PURE__*/index_js_.createElement("p",{className:"text-sm text-base-secondary font-semibold uppercase"},"a Church-centric data pipeline"),/*#__PURE__*/index_js_.createElement("h1",{className:"py-4 text-3xl lg:text-5xl tracking-tight font-extrabold text-white"},"Syncs with your existing services and data."),/*#__PURE__*/index_js_.createElement("p",{className:"text-lg leading-6 text-dark-secondary/60"},"Apollos syncs data with the other services you already depend on. Phasellus lorem quam molestie id quisque diam aenean nulla in. Accumsan in quis quis nunc, ullamcorper malesuada. Eleifend condimentum id viverra nulla."),/*#__PURE__*/index_js_.createElement("div",{className:"flex flex-col items-center"},/*#__PURE__*/index_js_.createElement("div",{className:"mb-8 mt-14 aspect-w-5 aspect-h-3 md:aspect-w-2 md:aspect-h-1"},/*#__PURE__*/index_js_.createElement(J,{className:"transform rounded-md object-cover object-left-top",src:"../images/pipeline.png",alt:"Pipeline Screenshot",__imageData:__webpack_require__(4818)})),/*#__PURE__*/index_js_.createElement("a",{href:"#",className:"w-full sm:w-auto px-6 py-3 text-base font-medium text-base-secondary bg-white shadow-sm rounded-md inline-flex items-center justify-center gap-3 hover:bg-base-secondary hover:text-white"},/*#__PURE__*/index_js_.createElement(RocketLaunch_esm,{"aria-hidden":"true",className:"h-5 w-5"}),"Explore integrations")))),/*#__PURE__*/index_js_.createElement("div",{className:"space-y-12"},/*#__PURE__*/index_js_.createElement("div",null,/*#__PURE__*/index_js_.createElement("p",{className:"text-base text-base-secondary font-semibold uppercase"},"Our Blueprint"),/*#__PURE__*/index_js_.createElement("h1",{className:"text-5xl font-extrabold text-black"},"For ",/*#__PURE__*/index_js_.createElement("span",{className:"italic"},"the")),/*#__PURE__*/index_js_.createElement("h1",{className:"text-5xl font-extrabold text-black"},"Kingdom.")),/*#__PURE__*/index_js_.createElement("div",null,/*#__PURE__*/index_js_.createElement("dl",{className:"lg:grid lg:grid-cols-3 lg:gap-8"},features.map(feature=>/*#__PURE__*/index_js_.createElement("div",{key:feature.name},/*#__PURE__*/index_js_.createElement("dt",null,/*#__PURE__*/index_js_.createElement("div",{className:"flex items-center justify-center h-12 w-12 rounded-full bg-icon-bluegreen text-base-secondary shadow-sm"},/*#__PURE__*/index_js_.createElement(feature.icon,{className:"h-6 w-6","aria-hidden":"true"})),/*#__PURE__*/index_js_.createElement("p",{className:"mt-5 text-lg leading-6 font-medium text-gray-900"},feature.name)),/*#__PURE__*/index_js_.createElement("dd",{className:"mt-2 text-base text-gray-500"},feature.description)))))))),/*#__PURE__*/index_js_.createElement("footer",{className:"footer"},/*#__PURE__*/index_js_.createElement("div",{className:"max-w-7xl mx-auto px-4 py-16 lg:py-20 flex flex-col items-center space-y-6"},/*#__PURE__*/index_js_.createElement("h1",{className:"text-4xl font-extrabold text-white"},"Lorem ipsum"),/*#__PURE__*/index_js_.createElement("p",{className:"text-center leading-6 text-dark-secondary/60"},"Ac euismod vel sit maecenas id pellentesque eu sed consectetur. Malesuada adipiscing sagittis vel nulla nec."),/*#__PURE__*/index_js_.createElement("a",{href:"#",className:"w-full sm:w-auto px-6 py-3 text-base font-medium text-base-secondary bg-white shadow rounded-md inline-flex items-center justify-center hover:bg-base-secondary hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-base-secondary"},"Get started")))));};/* harmony default export */ const pages = (IndexPage);
...
var React = __webpack_require__(2556);

function Apollos (props) {
    return React.createElement("svg",props,[React.createElement("path",{"fillRule":"evenodd","clipRule":"evenodd","d":"M0 22.5559L6.55164 4.66699H10.1871L16.7388 22.5559H0ZM8.26975 9.0172L4.83198 19.1569H11.9157L8.47793 9.0172H8.26975Z","fill":"#F4F7F8","key":0}),React.createElement("path",{"d":"M18.1167 27.3284H21.5697V20.5173H21.6751C22.1533 21.5779 23.199 22.7628 25.2092 22.7628C28.0462 22.7628 30.259 20.4676 30.259 16.2086C30.259 11.8336 27.9489 9.66264 25.2173 9.66264C23.1341 9.66264 22.1371 10.9304 21.6751 11.9661H21.5211V9.82836H18.1167V27.3284ZM21.4968 16.192C21.4968 13.9216 22.437 12.4716 24.1149 12.4716C25.8252 12.4716 26.733 13.9879 26.733 16.192C26.733 18.4126 25.809 19.9538 24.1149 19.9538C22.4532 19.9538 21.4968 18.4624 21.4968 16.192Z","fill":"#F4F7F8","key":1}),React.createElement("path",{"d":"M37.7299 22.8042C41.5071 22.8042 43.8578 20.161 43.8578 16.2417C43.8578 12.2976 41.5071 9.66264 37.7299 9.66264C33.9526 9.66264 31.602 12.2976 31.602 16.2417C31.602 20.161 33.9526 22.8042 37.7299 22.8042ZM37.7461 20.0698C36.0034 20.0698 35.1117 18.4375 35.1117 16.2169C35.1117 13.9962 36.0034 12.3556 37.7461 12.3556C39.4564 12.3556 40.348 13.9962 40.348 16.2169C40.348 18.4375 39.4564 20.0698 37.7461 20.0698Z","fill":"#F4F7F8","key":2}),React.createElement("path",{"d":"M49.0995 5.58594H45.6465V22.5556H49.0995V5.58594Z","fill":"#F4F7F8","key":3}),React.createElement("path",{"d":"M54.8621 5.58594H51.4091V22.5556H54.8621V5.58594Z","fill":"#F4F7F8","key":4}),React.createElement("path",{"d":"M62.797 22.8042C66.5743 22.8042 68.9249 20.161 68.9249 16.2417C68.9249 12.2976 66.5743 9.66264 62.797 9.66264C59.0198 9.66264 56.6691 12.2976 56.6691 16.2417C56.6691 20.161 59.0198 22.8042 62.797 22.8042ZM62.8132 20.0698C61.0705 20.0698 60.1789 18.4375 60.1789 16.2169C60.1789 13.9962 61.0705 12.3556 62.8132 12.3556C64.5235 12.3556 65.4151 13.9962 65.4151 16.2169C65.4151 18.4375 64.5235 20.0698 62.8132 20.0698Z","fill":"#F4F7F8","key":5}),React.createElement("path",{"d":"M81.0727 13.4576C80.7647 11.1127 78.9166 9.66264 75.7716 9.66264C72.5861 9.66264 70.4867 11.1707 70.4948 13.6233C70.4867 15.5291 71.662 16.7637 74.0937 17.2609L76.2499 17.7C77.336 17.9238 77.8305 18.3298 77.8467 18.9678C77.8305 19.7218 77.028 20.2604 75.8203 20.2604C74.5882 20.2604 73.7695 19.7218 73.5588 18.6861L70.1625 18.8684C70.4867 21.3045 72.5131 22.8042 75.8121 22.8042C79.0382 22.8042 81.3483 21.1222 81.3564 18.6115C81.3483 16.772 80.173 15.67 77.7575 15.1645L75.5041 14.7005C74.345 14.4437 73.9154 14.0376 73.9235 13.4245C73.9154 12.6622 74.7584 12.165 75.8284 12.165C77.028 12.165 77.7413 12.8362 77.9115 13.6565L81.0727 13.4576Z","fill":"#F4F7F8","key":6}),React.createElement("path",{"d":"M87.7652 22.5552L91.0353 25.6499V17.6259H95.8675V14.2788H91.0353V9.33301H87.7652V14.2788H82.933V17.6259H87.7652V22.5552Z","fill":"#17B582","key":7})]);
}

Apollos.defaultProps = {"width":"96","height":"28","viewBox":"0 0 96 28","fill":"none"};

module.exports = Apollos;

Apollos.default = Apollos;
